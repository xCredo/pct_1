...
if __name__ == "__main__":
    draw(["1/data_thread.txt","2/data_thread.txt","3/data_thread.txt","4/data_thread_winda.txt","5/data_thread_winda.txt"], ["version1","version2","version3","version4","version5"])